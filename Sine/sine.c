...
int inv_tan = 0x2D00;   // These values represent 45 degrees, in fixed point using 12 bits
int rot_angle = 0x2D00; // so the decimal value 45 is shifted to the left 12 times
